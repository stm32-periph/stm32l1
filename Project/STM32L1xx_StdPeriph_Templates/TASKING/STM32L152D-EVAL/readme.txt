/**
  @page TASKING_STM32L152D TASKING Project Template for STM32L1xx Ultra Low Power High-density devices
  ...
  *          Library and working with TASKING VX-toolset for ARM Cortex-M v4.1r1.
  *******************************************************************************
...
- TASKING                     : This folder contains
     ...
     - stm32l1xx_hd.lsl       : This file is TASKING linker script that contains the 
                                STM32L1xx vector table and used to place program code (readonly) 
...
@par How to use it ?
 ...
 - Browse to  TASKING workspace directory and select the project: 
   - STM32L152D_EVAL: to configure the project for STM32L1xx devices.
 ...
 @note The needed define symbols for this config are already declared in the
       preprocessor section: USE_STM32L152D_EVAL, STM32L1XX_HD, USE_STDPERIPH_DRIVER 
