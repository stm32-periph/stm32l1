/**
  @page TASKING_STM32L152 TASKING Project Template for STM32L1xx Ultra Low Power Medium-density devices
...
- TASKING                     : This folder contains
     ...
     - stm32l1xx_md.lsl        : This file is TASKING linker script that contains the 
...
@par How to use it ?
 ...
 - Browse to  TASKING workspace directory and select the project: 
   - STM32L152_EVAL: to configure the project for STM32L1xx devices.
 ...
 @note The needed define symbols for this config are already declared in the
       preprocessor section: USE_STM32L152_EVAL, STM32L1XX_MD, USE_STDPERIPH_DRIVER 
