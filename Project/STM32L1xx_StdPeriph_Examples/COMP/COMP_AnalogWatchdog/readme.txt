...
peripherals in window mode:
  ...
  - The input voltage is configured to be connected to PB5 (On STM32L152-EVAL:
    RV3 is used to simulate an input voltage)
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics STM32L152-EVAL (STM32L1xx Ultra 
    Low Power Medium-Density) evaluation board and can be easily tailored to
