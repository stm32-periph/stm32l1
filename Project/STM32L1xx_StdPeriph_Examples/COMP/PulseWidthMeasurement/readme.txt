...
@par Example Description 
  ...
  - External signal should be connected to PB5. Pulse is computed in microsecond
    then displayed on Glass LCD.
...
In order to make the program work, you must do the following :
 ...
 - Run the example
 - Connect external signal to PB5
 - The measured pulse width is displayed on Glass LCD.
