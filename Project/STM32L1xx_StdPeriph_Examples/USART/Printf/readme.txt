...
@par Hardware and Software environment
  ...
  - STM32L152-EVAL Set-up
    - USART2 (EVAL_COM1)  
       ...
       - Make sure that JP19 is open and JP5 is in position 2<->3
    - USART3 (EVAL_COM2)  
       - Connect a null-modem female/female RS232 cable between the DB9 connector 
...
@note 
  - The free Lite version of TrueSTUDIO do not support printf() redirection.
    For more information, see "note.txt" under "STM32L1xx_StdPeriph_Template\TrueSTUDIO".
