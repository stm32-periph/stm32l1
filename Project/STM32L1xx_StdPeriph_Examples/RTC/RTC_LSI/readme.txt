...
LED1 connected to PD.01 is toggled inside the RTC WakeUp interrupt each 1s.
...
The LSI clock is output on MCO (PA.08) pin and can be measured by on oscilloscope
...
procedure:
 ...
 - When calibration is done a led connected to PD.02 is turned ON to indicate the
