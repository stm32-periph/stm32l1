...
memory using half page write operation. The Halfpage operation is possible only
from SRAM.
...
@note The stm32l1xx_flash_ramfunc.c file should be placed in Internal SRAM.
      ARM Compiler
      ------------
